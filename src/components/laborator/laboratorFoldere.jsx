    ...
    <>
        ...
        <div className="fs-4 fw-semibold">
          ...
          <ul className="fs-5">
            ...
            <li>
              ...
              scurtături. Deschide <strong>DESKTOP</strong> (apeși pe el click
              un stânga).
            </li>
            <li>
          ...
          <div className="lab-foldere-note p-1">
            ...
            <ul className="fs-5">
              <li>
                ...
                <strong>3</strong> foldere:{" "}
                <strong>CEAPA, ROSIE, CARTOFI</strong>
              </li>
              <li>
                Navighează înapoi (apasă pe butonul{" "}
                <i className="fa-solid fa-arrow-left"></i>) din colțul stânga
                sus
              </li>
              <li>
      ...
      <div className="lab-foldere-ajutor">
        ...
        <div className="lab-foldere-ajutor-item my-3">
          ...
          <div className="pos-c">
            <img src={copy_folder} alt="Copy a folder video" className="w-75" />
          </div>
        </div>
        {/* PASTE */}
        <div className="lab-foldere-ajutor-item my-3">
          ...
          <div className="pos-c">
            <img src={move_folder} alt="Move a folder video" className="w-75" />
          </div>
        </div>
      </div>
    </>
